...
use crate::domain::owner::role::{Role, RoleRepository};
...
use crate::infrastructure::owner::db::staff::SeaOrmStaffRepository;
use crate::infrastructure::owner::db::role::SeaOrmRoleRepository;
use crate::infrastructure::owner::db::permission::SeaOrmPermissionRepository;
use crate::infrastructure::owner::db::user_role::SeaOrmStaffRoleRepository;
use crate::infrastructure::owner::db::role_permission::SeaOrmRolePermissionRepository;
