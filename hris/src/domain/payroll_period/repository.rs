...
use uuid::Uuid;
use crate::domain::payroll_period::entity::Model;
use crate::domain::errors::AppResult;
use crate::domain::shared::dtos::{PaginationQuery, PaginatedResponse};

#[async_trait]
pub trait PayrollPeriodRepository: Send + Sync {
    async fn create(&self, payroll_period: Model) -> AppResult<Model>;
    async fn delete(&self, id: Uuid) -> AppResult<()>;
    async fn update(&self, payroll_period: Model) -> AppResult<Model>;
