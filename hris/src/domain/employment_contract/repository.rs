...
use uuid::Uuid;
use crate::domain::employment_contract::entity::Model;
use crate::domain::errors::AppResult;
use crate::domain::shared::dtos::{PaginationQuery, PaginatedResponse};

#[async_trait]
pub trait EmployeeContractRepository: Send + Sync {
    async fn create(&self, contract: Model) -> AppResult<Model>;
    async fn delete(&self, id: Uuid) -> AppResult<()>;
    async fn update(&self, contract: Model) -> AppResult<Model>;
