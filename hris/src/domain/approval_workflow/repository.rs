...
use uuid::Uuid;
use crate::domain::approval_workflow::entity::Model;
use crate::domain::errors::AppResult;
use crate::domain::shared::dtos::{PaginationQuery, PaginatedResponse};

#[async_trait]
pub trait ApprovalWorkflowRepository: Send + Sync {
    async fn create(&self, approval_workflow: Model) -> AppResult<Model>;    
    async fn delete(&self, id: Uuid) -> AppResult<()>;
    async fn update(&self, approval_workflow: Model) -> AppResult<Model>;
