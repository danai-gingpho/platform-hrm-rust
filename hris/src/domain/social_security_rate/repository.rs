...
use uuid::Uuid;
use crate::domain::social_security_rate::entity::Model;
use crate::domain::errors::AppResult;
use crate::domain::shared::dtos::{PaginationQuery, PaginatedResponse};

#[async_trait]
pub trait SocialSecurityRateRepository: Send + Sync {
    async fn create(&self, social_security_rate: Model) -> AppResult<Model>;
    async fn delete(&self, id: Uuid) -> AppResult<()>;
    async fn update(&self, social_security_rate: Model) -> AppResult<Model>;
