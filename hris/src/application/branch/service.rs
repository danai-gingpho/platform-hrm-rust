...
impl BranchService {
    ...
    pub async fn get_all_branches(&self, query: PaginationQuery) -> AppResult<PaginatedResponse<Branch>> {
        self.repository.find_all(query).await
    }

    pub async fn get_branch_by_id(&self, id: Uuid) -> AppResult<Branch> {
        self.repository.find_by_id(id).await
    }

    pub async fn create_branch(&self, req: CreateBranchRequest) -> AppResult<Branch> {
        ...
        self.repository.create(branch).await
    }

    pub async fn update_branch(&self, id: Uuid, req: UpdateBranchRequest) -> AppResult<Branch> {
        let mut branch = self.repository.find_by_id(id).await?;
        ...
        self.repository.update(branch).await
    }

    pub async fn delete_branch(&self, id: Uuid) -> AppResult<()> {
