...
pub struct CompanyResponse {
    ...
    #[schema(example = "contact@company.com")]
    pub email: String,
...
/// DTO สำหรับรับข้อมูลตอนสร้าง Company ใหม่ (ไม่ต้องส่ง id, created_at, updated_at มา)
...
/// DTO สำหรับรับข้อมูลตอนอัปเดตแก้ไข Company (ห้ามแก้ code และเปิดให้เลือกอัปเดตเฉพาะบางฟิลด์ได้)
...
// --- แถมฟังก์ชันสำหรับแปลงจาก Sea-ORM Model ไปเป็น CompanyResponse DTO ได้ง่ายๆ ---
