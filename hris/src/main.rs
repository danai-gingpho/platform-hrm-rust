...
// Repositories
use crate::infrastructure::db::legal_entity::SeaOrmLegalEntityRepository;
...
// gRPC Handlers
use crate::interface::grpc::legal_entity_handler::{LegalEntityGrpcHandler, LegalEntityServiceServer};
...
async fn main() -> anyhow::Result<()> {
    ...
    let legal_entity_repo = Arc::new(SeaOrmLegalEntityRepository::new(db.clone()));
    let legal_entity_service = Arc::new(LegalEntityService::new(legal_entity_repo));
    ...
    let grpc_router = Server::builder()
        .add_service(LegalEntityServiceServer::new(LegalEntityGrpcHandler::new(legal_entity_service.clone())))
    ...
    let rest_router = Router::new()
        ...
        .nest("/legal-entities", http::legal_entity_handler::router(legal_entity_service.clone()))
